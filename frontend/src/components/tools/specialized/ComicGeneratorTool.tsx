...
import { Loader2, Image, AlertCircle, CheckCircle2, X } from 'lucide-react';
...
export default function ComicGeneratorTool({ isOpen = true, onClose }: ComicGeneratorToolProps) {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <motion.div
          className="bg-[#0a0a0f] rounded-xl border border-white/10 w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col"
...
// Named export for index.ts compatibility
export { ComicGeneratorTool };
